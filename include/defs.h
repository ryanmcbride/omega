...
extern const int ML0;
extern const int NML_0;
extern const int ML1;
extern const int NML_1;
extern const int ML2;
extern const int NML_2;
extern const int ML3;
extern const int NML_3;
extern const int ML4;
extern const int NML_4;
extern const int ML5;
extern const int NML_5;
extern const int ML6;
extern const int NML_6;
extern const int ML7;
extern const int NML_7;
extern const int ML8;
extern const int NML_8;
extern const int ML9;
extern const int NML_9;
extern const int ML10;
extern const int NML_10;

extern const int NUMMONSTERS;

extern const int RANDOM;
extern const int HORNET;
extern const int MEND_PRIEST;
extern const int ITIN_MERCH;
extern const int GUARD;
extern const int NPC;
extern const int SHEEP;
extern const int MERCHANT;
extern const int ZERO_NPC;
extern const int HISCORE_NPC;
extern const int GRUNT;
extern const int TSETSE;
extern const int FNORD;
extern const int SEWER_RAT;
extern const int AGGRAVATOR;
extern const int BLIPPER;
extern const int GOBLIN;
extern const int PHANTASTICON;
extern const int ROBOT;
extern const int GEEK;
extern const int BOROGROVE;
extern const int QUAIL;
extern const int BADGER;
extern const int HAWK;
extern const int DEER;
extern const int CAMEL;
extern const int ANTEATER;
extern const int BUNNY;
extern const int TROUT;
extern const int BASS;
extern const int PARROT;
extern const int HYENA;
extern const int APPR_NINJA;
extern const int NIGHT_GAUNT;
extern const int SNEAK_THIEF;
extern const int EYE;
extern const int TOVE;
extern const int NASTY;
extern const int GHOST;
extern const int ENCHANTOR;  /* use 'OR' to avoid conflict with circle rank */
extern const int MURK;
extern const int GOBLIN_CHIEF;
extern const int WOLF;
extern const int ANT;
extern const int ELEPHANT;
extern const int HORSE;
extern const int SALAMANDER;
extern const int CATOBLEPAS;
extern const int L_FDEMON;
extern const int ACID_CLOUD;
extern const int PHANTOM;
extern const int GOBLIN_KING;
extern const int PTERODACTYL;
extern const int GOBLIN_SHAMAN;
extern const int LION;
extern const int BRIGAND;
extern const int BEAR;
extern const int MAMBA;
extern const int MANOWAR;
extern const int WEREHUMAN;
extern const int THOUGHTFORM;
extern const int MANTICORE;
extern const int TASMANIAN;
extern const int AUTO_MINOR;
extern const int DENEBIAN;
extern const int JUBJUB;
extern const int HAUNT;
extern const int INCUBUS;
extern const int SATYR;
extern const int CROC;
extern const int TORPOR;
extern const int DOBERMAN;
extern const int FUZZY;
extern const int SERV_LAW;
extern const int SERV_CHAOS;
extern const int SWARM;
extern const int BAN_SIDHE;
extern const int GRUE;
extern const int GENIN;
extern const int DRAGONETTE;
extern const int TESLA;
extern const int WYVERN;
extern const int CATEAGLE;
extern const int FROST_DEMON;
extern const int SPECTRE;
extern const int NECROMANCER;
extern const int SHADOW;
extern const int BOGTHING;
extern const int ASTRAL_VAMP;
extern const int LAVA_WORM;
extern const int MANABURST;
extern const int OUTER_DEMON;
extern const int MIRRORSHADE;
extern const int FIRE_ELEM;
extern const int AIR_ELEM;
extern const int WATER_ELEM;
extern const int EARTH_ELEM;
extern const int BANDERSNATCH;
extern const int LICHE;
extern const int TRITON;
extern const int MAST_THIEF;
extern const int TRICER;
extern const int RAKSHASA;
extern const int DEMON_SERP;
extern const int ANGEL;
extern const int CHUNIN;
extern const int BEHEMOTH;
extern const int NAZGUL;
extern const int UNICORN;
extern const int ROUS;
extern const int ILL_FIEND;
extern const int GREAT_WYRM;
extern const int FLAME_DEV;
extern const int LURKER;
extern const int SANDMAN;
extern const int MIRRORMAST;
extern const int ELDER_GRUE;
extern const int LOATHLY;
extern const int ZOMBIE;
extern const int RICOCHET;
extern const int INNER_DEMON;
extern const int GOOD_FAIRY;
extern const int BAD_FAIRY;
extern const int AUTO_MAJOR;
extern const int DRAGON;
extern const int JABBERWOCK;
extern const int FDEMON_L;
extern const int TIGERSHARK;
extern const int JONIN;
extern const int SHADOW_SLAY;
extern const int MIL_PRIEST;
extern const int COMA;
extern const int HIGH_ANGEL;
extern const int JOTUN;
extern const int INVIS_SLAY;
extern const int KING_WYV;
extern const int DEATHSTAR;
extern const int THAUMATURGIST;
extern const int VAMP_LORD;
extern const int ARCHANGEL;
extern const int DEMON_PRINCE;
extern const int DEATH;
extern const int EATER;
extern const int LAWBRINGER;
extern const int DRAGON_LORD;
extern const int DEMON_EMP;
extern const int LORD_EARTH;
extern const int LORD_AIR;
extern const int LORD_WATER;
extern const int LORD_FIRE;
extern const int ELEM_MASTER;
