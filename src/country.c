...
void load_dlair(empty, populate) int empty;
int populate;
{
	int i, j;
	char site;
...
void load_speak(empty, populate) int empty;
int populate;
{
...
void load_misle(empty, populate) int empty;
int populate;
{
	int i, j;
	char site;
...
void load_temple(deity, populate) int deity;
int populate;
{
	int i, j;
	char site;
...
void random_temple_site(i, j, deity, populate) int i, j, deity, populate;
{
...
void make_high_priest(i, j, deity) int i, j, deity;
{
