...
void knowledge(blessing) int blessing;
{
  if (blessing < 0)
...
void flux(blessing) int blessing;
{
...
void displace(blessing) int blessing;
{
  if (blessing > -1)
  {
...
void invisible(blessing) int blessing;
{
  if (blessing > -1)
  {
...
void warp(blessing) int blessing;
{
  int newlevel;
...
void alert(blessing) int blessing;
{
  if (blessing > -1)
  {
...
void regenerate(blessing) int blessing;
{
  if (blessing < 0)
    heal(blessing * 10);
  else
...
void haste(blessing) int blessing;
{
  if (blessing > -1)
  {
    if (!Player.status[HASTED])
...
void recover_stat(blessing) int blessing;
{
  if (blessing < 0)
  {
...
void augment(blessing) int blessing;
{
  if (blessing < 0)
  {
    mprint("You feel a cold surge!");
...
void breathe(blessing) int blessing;
{
  if (blessing > -1)
  {
...
void sanctify(blessing) int blessing;
{
  if (blessing > -1)
  {
...
void accuracy(blessing) int blessing;
{
  if (blessing > -1)
  {
