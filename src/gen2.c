...
void make_stairs(fromlevel) int fromlevel;
{
  int i, j;
...
void make_general_map(terrain) char *terrain;
{
  int i, j;
...
void room_corridor(fx, fy, tx, ty, baux) int fx, fy, tx, ty, baux;
{
...
void maze_corridor(fx, fy, tx, ty, rsi, num) int fx, fy, tx, ty;
char rsi, num;
{
  if (num < 6)
  {
