...
void weapon_acidwhip(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
...
void weapon_scythe(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  mprint("Slice!");
...
void weapon_demonblade(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  if (o->blessing > -1)
...
void weapon_lightsabre(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  if (!o->known)
...
void weapon_tangle(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  if ((random_range(2) == 1) && (!m_immunityp(m, NORMAL_DAMAGE)))
...
void weapon_arrow(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
...
void weapon_bolt(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  if ((Player.possessions[O_WEAPON_HAND] != NULL) &&
...
void weapon_mace_disrupt(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
...
void weapon_normal_hit(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  p_hit(m, Player.dmg + dmgmod, NORMAL_DAMAGE);
...
void weapon_bare_hands(dmgmod, m) int dmgmod;
struct monster *m;
{
  p_hit(m, Player.dmg + dmgmod, NORMAL_DAMAGE);
}
...
void weapon_vorpal(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
...
void weapon_desecrate(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  o->known = 2;
...
void weapon_firestar(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  if (random_range(3) == 1)
...
void weapon_victrix(dmgmod, o, m) int dmgmod;
pob o;
struct monster *m;
{
  if (m->meleef == M_MELEE_SPIRIT)
