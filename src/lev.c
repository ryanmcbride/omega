...
void populate_level(monstertype) int monstertype;
{
  pml head, tml;
...
void make_site_monster(i, j, mid) int i, j, mid;
{
...
pmt m_create(x, y, kind, level) int x, y, kind, level;
{
  pmt newmonster;
  int monster_range;
  int mid;
...
void make_site_treasure(i, j, itemlevel) int i, j, itemlevel;
{
...
void make_specific_treasure(i, j, itemid) int i, j, itemid;
{
  pol tmp;
