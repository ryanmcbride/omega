...
void m_hit(m, dtype) struct monster *m;
int dtype;
{
...
void tacmonster(m) struct monster *m;
{
  int i = 0;
...
void monster_melee(m, hitloc, bonus) struct monster *m;
char hitloc;
int bonus;
{
...
int monster_hit(m, hitloc, bonus) struct monster *m;
char hitloc;
int bonus;
{
...
void transcribe_monster_actions(m) struct monster *m;
{
  int i;
