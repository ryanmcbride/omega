...
void m_talk_druid(m) struct monster *m;
{
  int i;
  pml curr;
...
void m_talk_silent(m) struct monster *m;
{
...
void m_talk_stupid(m) struct monster *m;
{
...
void m_talk_greedy(m) struct monster *m;
{
...
void m_talk_hungry(m) struct monster *m;
{
...
void m_talk_guard(m) struct monster *m;
{
  if (m_statusp(m, HOSTILE))
  {
...
void m_talk_assassin(m) struct monster *m;
{
...
void m_talk_im(m) struct monster *m;
{
...
void m_talk_man(m) struct monster *m;
{
...
void m_talk_evil(m) struct monster *m;
{
...
void m_talk_robot(m) struct monster *m;
{
  if (m->uniqueness == COMMON)
  {
    strcpy(Str2, "The ");
...
void m_talk_slithy(m) struct monster *m;
{
  mprint("It can't talk -- it's too slithy!");
}

void m_talk_mimsy(m) struct monster *m;
{
  mprint("It can't talk -- it's too mimsy!");
}

void m_talk_burble(m) struct monster *m;
{
...
void m_talk_beg(m) struct monster *m;
{
  if (m->uniqueness == COMMON)
  {
    strcpy(Str2, "The ");
...
void m_talk_hint(m) struct monster *m;
{
  if (m->uniqueness == COMMON)
  {
    strcpy(Str2, "The ");
...
void m_talk_gf(m) struct monster *m;
{
...
void m_talk_ef(m) struct monster *m;
{
...
void m_talk_seductor(m) struct monster *m;
{
  if (m->uniqueness == COMMON)
  {
    strcpy(Str2, "The ");
...
void m_talk_demonlover(m) struct monster *m;
{
  if (m->uniqueness == COMMON)
  {
    strcpy(Str2, "The ");
...
void m_talk_horse(m) struct monster *m;
{
  if (m_statusp(m, HOSTILE))
...
void m_talk_hyena(m) struct monster *m;
{
  mprint("The hyena only laughs at you...");
}

void m_talk_parrot(m) struct monster *m;
{
  mprint("Polly wanna cracker?");
}

void m_talk_servant(m) struct monster *m;
{
...
void m_talk_animal(m) struct monster *m;
{
  if (m->uniqueness == COMMON)
  {
    strcpy(Str2, "The ");
...
void m_talk_scream(m) struct monster *m;
{
...
void m_talk_archmage(m) struct monster *m;
{
  if (m_statusp(m, HOSTILE))
  {
...
void m_talk_merchant(m) struct monster *m;
{
  if (!m_statusp(m, HOSTILE))
  {
...
void m_talk_prime(m) struct monster *m;
{
  if (!m_statusp(m, HOSTILE))
  {
